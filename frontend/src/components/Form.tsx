  ...
  return (
    <div id="contact">
      <div className="mt-5 md:px-2">
        <div className="flex flex-col md:flex-row p-4 py-10  rounded-lg  md:py-10 max-w-6xl mx-auto sm:mt-20 mb-20 justify-center">
          <div className="md:w-7/12 rounded md:rounded-none md:rounded-l-sm md:border-indigo-300 border p-5 md:p-10">
            <h2 className="text-xl md:text-3xl font-semibold text-gray-800 mb-6">
              Get in touch and  <strong className="bg-clip-text text-transparent bg-gradient-to-bl from-blue-500 to-orange-400">schedule your demo now!</strong>
            </h2>
        ...
        <div className="mt-20 md:mt-0 md:w-5/12 bg-gradient-to-br from-[#5B86E5]  to-red-200 text-white border border-e-indigo-300 border-y-indigo-300 border-l-indigo-300 md:border-l-0 rounded md:rounded-none md:rounded-r-sm" >
