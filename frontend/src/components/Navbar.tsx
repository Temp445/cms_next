    ...
    <>
      <nav className="flex items-center justify-between md:pt-5 lg:pb-10 px-4 md:px-0 lg:px-6 relative">
        ...
        <div className="hidden md:flex items-center space-x-2">
          ...
          <Link href="#contact" className="flex items-center text-gray-800 hover:text-white text-base font-semibold relative px-4 py-2 rounded-full transition-all duration-300 ease-in-out hover:bg-gradient-to-tr from-blue-500 to-violet-500">
            <FileText className="w-4 h-4 mr-2" />
            Book A Demo
          </Link>

          <Link href="#client" className="flex items-center text-gray-800 hover:text-white text-base font-semibold relative px-4 py-2 rounded-full transition-all duration-300 ease-in-out hover:bg-gradient-to-tr from-blue-500 to-violet-500">
...
<div className='w-12 h-12  bg-gray-400 flex items-center justify-center'>
        ...
        <Link href="/signin" className="flex flex-col items-center justify-center text-white w-full">
          <span className="w-full h-12  bg-gradient-to-r from-red-500 to-red-400 flex items-center justify-center">Sign In</span>
        </Link>

        <Link href="#contact" className="flex flex-col items-center justify-center text-gray-600">
