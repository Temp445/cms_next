    ...
    <>
      <nav className="flex items-center justify-between md:pt-5 lg:pb-10 px-4 md:px-0 lg:px-6 relative">
        ...
        <div className="hidden md:flex items-center space-x-2">
          <Link
            href="#features"
            className="flex items-center text-gray-800 hover:text-white text-base font-semibold relative px-4 py-2 rounded-full transition-all duration-300 ease-in-out hover:bg-gradient-to-tr from-blue-500  to-violet-500"
          >
        ...
        <div className="hidden md:flex items-center space-x-4">
          <Link
            href="/signin"
            className="bg-gradient-to-r from-green-400 to-green-300 text-white px-4 py-1 md:px-2 lg:px-6 xl:py-2 rounded-md font-medium hover:opacity-90 transition"
          >
            Sign In
          </Link>
        </div>
